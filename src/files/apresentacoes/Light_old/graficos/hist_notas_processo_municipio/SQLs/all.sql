SELECT
    municipio, 
    cast(count(proc.id) as float) / count(contratos.id) as qtd_proc, 
    cast(count(distinct(toi.id)) as float) / count(contratos.id) as qtd_toi, 
    cast(count(distinct(negativacao.id)) as float)  / count(contratos.id) as qtd_nega, 
    cast(count(distinct(corte.id)) as float)  / count(contratos.id) as qtd_corte, 
    cast(count(distinct(reclamacao.id)) as float)  / count(contratos.id) as qtd_reclamacao, 
